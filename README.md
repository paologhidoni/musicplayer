...
- [x] As a user listening to music on a mobile, I want to be able to access the music player from any device.
...
![Preview image of the music player](./assets/img/music-player-screenshot.png)
